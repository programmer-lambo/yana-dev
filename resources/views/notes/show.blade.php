        ...
        <template x-if="!loading && !error && note">
            <article class="bg-white rounded-xl p-8 shadow">
                ...
                <div class="flex justify-between items-center mb-4">
                    <span
                        class="text-xs font-medium bg-blue-100 text-blue-600 px-3 py-1 rounded-full"
                ...
                <div class="flex items-center gap-3 text-sm text-gray-400 mb-8 pb-6 border-b">
                    <span>✍️ <span x-text="note.author?.name"></span></span>
                    <span>•</span>
